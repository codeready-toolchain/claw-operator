...
The system SHALL define a CustomResourceDefinition named `OpenClawInstance` in the API group `openclaw.codeready-toolchain.com/v1alpha1`.
...
- **WHEN** user runs `kubectl get crd openclawinstances.openclaw.codeready-toolchain.com`
