...
The system SHALL define a CustomResourceDefinition named `OpenClaw` in the API group `claw.sandbox.redhat.com/v1alpha1`.
...
- **WHEN** user runs `kubectl get crd openclaws.claw.sandbox.redhat.com`
