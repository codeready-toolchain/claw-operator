...
func TestApplyDeployment(t *testing.T) {
	...
	t.Run("should create deployment on first apply", func(t *testing.T) {
		...
		reconciler := createClawReconciler()
		desired := makeUnstructuredDeployment("cou-create", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
		...
		assert.Equal(t, "ghcr.io/openclaw/openclaw:2026.6.10", deployment.Spec.Template.Spec.Containers[0].Image)
	})
	...
	t.Run("should not update on identical second apply", func(t *testing.T) {
		...
		reconciler := createClawReconciler()
		desired1 := makeUnstructuredDeployment("cou-idempotent", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
		...
		desired2 := makeUnstructuredDeployment("cou-idempotent", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
	...
	t.Run("should update when replicas change", func(t *testing.T) {
		...
		reconciler := createClawReconciler()
		desired1 := makeUnstructuredDeployment("cou-replicas", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")

		_, err := reconciler.applyDeployment(ctx, desired1)
		require.NoError(t, err)

		desired2 := makeUnstructuredDeployment("cou-replicas", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
	...
	t.Run("should preserve annotations from other controllers", func(t *testing.T) {
		...
		reconciler := createClawReconciler()
		desired1 := makeUnstructuredDeployment("cou-annot", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
		...
		desired2 := makeUnstructuredDeployment("cou-annot", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
	...
	t.Run("should preserve labels from other controllers", func(t *testing.T) {
		...
		reconciler := createClawReconciler()
		desired1 := makeUnstructuredDeployment("cou-labels", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
		...
		desired2 := makeUnstructuredDeployment("cou-labels", namespace, "ghcr.io/openclaw/openclaw:2026.6.10")
...
func TestOpenClawImage(t *testing.T) {
	t.Run("should default image to ghcr.io/openclaw/openclaw:2026.6.10 when omitted", func(t *testing.T) {
		t.Cleanup(func() { deleteAndWaitAllResources(t, namespace) })
		...
		assert.Equal(t, "ghcr.io/openclaw/openclaw:2026.6.10", instance.Spec.Image)
	})
