...
- `Claw` — Main CRD. Spec: `configMode` (merge/overwrite), `credentials` ([]CredentialSpec), `auth` (AuthSpec: mode token/password, disableDevicePairing). Status: `conditions`, `url`, `gatewayTokenSecretRef`
